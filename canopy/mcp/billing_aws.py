"""MCP server for AWS billing and cost data."""
...
def get_cost_breakdown(region: str | None = None) -> dict[str, object]:
    ...
    results, summary = run_audit_with_recommendations(provider="aws", region=region)
